...
(function() {
  var Gk, _addEvent, _addHandler, _bind, _cancel, _checkType, _getMatcher, _gk_instances, _handleEvent, _handlers, _id, _level, _matcher, _matchesSelector, _removeHandler;
  _matcher = void 0;
  _level = 0;
  _id = 0;
  _handlers = {};
